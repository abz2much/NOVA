...
const hass = {
  states: {},
  callWS: async (m) => { if (m.type === "nova/get_panel_data") return PANEL; if (m.type === "nova/get_activity_log") return { entries: [] }; if (m.type === "nova/get_cognitive_status") return { learning: { days_of_data: 48, state_changes: 1, commands: 0, suggestions: 0 }, ignore_rules: 0 }; return {}; },
