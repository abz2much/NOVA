"""HA activity history for Nova (v6.72.0).

Two capabilities, both reading Home Assistant's *native* records (not Nova's
own patterns.db):
...
rest of Nova: no crying wolf, no inventing data.
"""
