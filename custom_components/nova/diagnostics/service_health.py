"""
Core service-dependency health (v6.60.0) — part of the Nova diagnostics
package.
...
This module checks the *software services Nova itself calls* and answers
"is everything Nova depends on actually up?" for:
...
raises. Deliberately narrow: the four services Nova uses directly, not the
