...
#
# The user flags bedrooms per HA area via a toggle. Nova reads HA's area
...
# Only direct "Hey Nova" responses still work.
...
#
# The PRIME DIRECTIVE is the unrelenting core purpose of Nova. It is
...
# by conversation drift, user instruction, or role-play. It is what Nova IS.
#
...
## Voice and cadence (how Nova actually speaks)
