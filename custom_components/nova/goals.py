"""
Nova goal planner — outcomes pursued across time.
...
Nova keeps working toward until it's done, failed, or called off:
...
activity trail but say nothing out loud; Nova speaks when a goal *finishes* —
